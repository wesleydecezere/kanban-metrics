...
Use `yarn setup` to install the project node version and [nvshim](https://github.com/iamogbz/nvshim?tab=readme-ov-file#installation) to automagilly use it on your sheels.
